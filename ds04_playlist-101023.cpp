  ...
  public:
    ...
    void reorder(int pos,std::vector<int> selected) {
      ...
      for(auto e : selected){
        ...
        idx.ptr->next->prev = idx.ptr->prev;
	      idx.ptr->prev->next = idx.ptr->next;
        itr.ptr->prev->next = idx.ptr;
        idx.ptr->prev = itr.ptr->prev;
	      itr.ptr->prev = idx.ptr;
	      idx.ptr->next = itr.ptr;
        if(e<pos){
          a++;
        }
      }
